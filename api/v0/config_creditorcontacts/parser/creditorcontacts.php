...
class HTMLParser
{
    ...
    public function parse()
    {
        ...
        // Select the CreditorContacts table
        $table_nodes = $xpath->query("//div[@id='CreditorContacts']//table[contains(@class, 'rpt_content_table')]");
        ...
        foreach ($rows as $row_index => $row) {
            ...
            $address = trim($cells->item(1)->nodeValue);
            $phone_number = trim($cells->item(2)->nodeValue);
