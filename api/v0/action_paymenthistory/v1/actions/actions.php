        ...
        for ($index = 0; $index < count($_FILES['files']['name']); $index++) {
            if (isset($_FILES['files']['name'][$index]) && $_FILES['files']['name'][$index] != '') {
                ...
                if (pathinfo($filename, PATHINFO_EXTENSION) === 'html') {
                    ...
                    $object_payment_histotry['']="Account#:";
                    ...
                    $query =
                        "INSERT INTO tbl_account_history_v1 (reference, report_date, furnisher, account, category, chester_pa, allen_tx, atlanta_ga, account_history_created_date)
