...
require_once 'parser/inquiries.php';
require_once 'db/inquiries.php';
...
try {
    ...
    if (!empty($inquiries)) {
        ...
        foreach ($inquiries as $inquiry) {
            ...
            echo '<td>'.htmlspecialchars($inquiry['type_of_business']).'</td>';
            echo '<td>'.htmlspecialchars($inquiry['date_of_inquiry']).'</td>';
            echo '<td>'.htmlspecialchars($inquiry['credit_bureau']).'</td>';
            echo '</tr>';
        }
        echo '</table>';
